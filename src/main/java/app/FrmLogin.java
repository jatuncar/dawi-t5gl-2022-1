...
public class FrmLogin extends JFrame {
	...
	public FrmLogin() {
		...
		lblUsuario.setBounds(24, 31, 57, 14);
		...
		lblClave.setBounds(24, 59, 57, 14);
		contentPane.add(lblClave);
		
		txtClave = new JPasswordField();
		txtClave.setBounds(91, 56, 159, 20);
		...
		btnIngresar.setBounds(320, 27, 89, 23);
	...
	void ingresar() {
		...
		// Usuario u = em.find(Usuario.class, 20);  busca solo por ID
